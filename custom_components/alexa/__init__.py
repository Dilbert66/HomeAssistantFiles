...
from . import flash_briefings, intent, smarter_home
from .const import (
...
CONF_SMART_HOME = 'smarter_home'

DEPENDENCIES = ['http']

ALEXA_ENTITY_SCHEMA = vol.Schema({
    vol.Optional(smarter_home.CONF_DESCRIPTION): cv.string,
    vol.Optional(smarter_home.CONF_DISPLAY_CATEGORIES): cv.string,
    vol.Optional(smarter_home.CONF_NAME): cv.string,
})
...
async def async_setup(hass, config):
    ...
    try:
        ...
        await smarter_home.async_setup(hass, smart_home_config)

...
from homeassistant.components.media_player.const import (
    ...
    SUPPORT_NEXT_TRACK,  MEDIA_TYPE_CHANNEL, SUPPORT_PLAY,  SUPPORT_PLAY_MEDIA)
...
SUPPORT_BROADLINK_TV = SUPPORT_TURN_OFF | SUPPORT_TURN_ON | \
    ...
    SUPPORT_PREVIOUS_TRACK | SUPPORT_NEXT_TRACK | SUPPORT_PLAY | SUPPORT_PLAY_MEDIA | SUPPORT_PAUSE | SUPPORT_STOP
...
class BroadlinkIRMediaPlayer(MediaPlayerDevice):
        ...
        for command in commands:
            for retry in range(DEFAULT_RETRY):
                try:
                    ...
                    _LOGGER.debug("sending ir code %s=%s [%s]",value,command,payload)
                    break
    ...
    def supported_features(self):
        _LOGGER.debug('returning supported features for broadlink')
